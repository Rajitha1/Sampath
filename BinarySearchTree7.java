...
class BST{
	...
	public boolean searchS(String title,int a){
	    
	    return searchS(root,title,a);
	}
	
	public boolean searchS(BSTNode node,String title,int a){
	    boolean found=false;
	    String t="";
	    if (node != null){

                 searchS(node.getLeft(),title);
		 t=node.getTitle();
...
public class BinarySearchTree7{
		...
		case 5:
		    System.out.print("\n\n\t\tEnter Book Title   : ");
		    boolean t=bst.searchS(br.readLine(),a);
		    if(!t)
